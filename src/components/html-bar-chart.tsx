...
/**
 * A very basic bar chart using simple HTML elements
 */
export const HtmlBarChart = component$(
  ({
    taxEntries,
    ...
    return (
      <div>
        ...
        {/* Scale indicator */}
        <div class="flex justify-between text-xs text-gray-500 mt-4 px-32 border-t pt-2">
          <div>$0k</div>
