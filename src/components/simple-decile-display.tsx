...
/**
 * Simple component to display decile-based UBI data without relying on any context
 */
export const SimpleDecileDisplay = component$(() => {
  // Local state
              ...
              <table class="min-w-full bg-white border border-gray-200">
                ...
                <tbody>
                  {decileData.value.map((entry) => {
                    ...
                    let descriptionKey = "";
                    switch (entry.decile) {
                      case 1: descriptionKey = "Lowest 10%"; break;
                      case 2: descriptionKey = "10-20%"; break;
                      case 3: descriptionKey = "20-30%"; break;
                      case 4: descriptionKey = "30-40%"; break;
                      case 5: descriptionKey = "40-50%"; break;
                      case 6: descriptionKey = "50-60%"; break;
                      case 7: descriptionKey = "60-70%"; break;
                      case 8: descriptionKey = "70-80%"; break;
                      case 9: descriptionKey = "80-90%"; break;
                      case 10: descriptionKey = "Highest 10%"; break;
                      default: descriptionKey = ""; break;
                    }
