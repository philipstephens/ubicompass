...
export const UbiCalculationComponent = component$(() => {
  try {
    ...
    return (
      <div>
        <div style="background-color: lightblue; padding: 5px; margin-bottom: 10px;">
          <h3>UBI Calculation Component</h3>
          <p>If you can see this, the UbiCalculationComponent is rendering correctly.</p>
    ...
    console.error("Error in UbiCalculationComponent:", error);
    return (
      <CspCardComponent
      ...
      >
        <div class="error-container">
          <h3>
            An error occurred while rendering the UBI Calculation component
          </h3>
          <p>
            Error details:{" "}
