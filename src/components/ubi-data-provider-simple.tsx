...
/**
 * Simple provider component for UBI data
 */
export const UbiDataProvider = component$(() => {
  console.log("UbiDataProvider initializing");
  ...
  useTask$(() => {
    console.log("Initializing data in UbiDataProvider");
  ...
  console.log("UbiDataProvider initialized");

  return (
    <div>
      <div style="background-color: lightgreen; padding: 5px; margin-bottom: 10px;">
        <h3>UBI Data Provider</h3>
        <p>
          If you can see this, the UbiDataProvider component is rendering
          correctly.
        </p>
        <p>Year Data Count: {ubiDataStore.yearData.length}</p>
        <p>Selected Year ID: {ubiDataStore.selectedYearId}</p>
        <p>Tax Entries Count: {ubiDataStore.taxEntries.length}</p>
      </div>
